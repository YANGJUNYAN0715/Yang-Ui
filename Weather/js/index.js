function weather(data) {
  ...
  dateDayname.innerHTML = data.code;
  ...
  function weatherIcon(t) {
    ...
    if (
      data.weather[t - 1].icon1.search("dayu") != -1 ||
      data.weather[0].icon1.search("baoyu") != -1
    ) {
      return "&#xe644;";
    }
...
window.onload = function () {
  ...
  script.src = `https://devapi.qweather.com/v7/weather/3d?location=101010100&key=4426879dbd924be4a3117d52622ceb41`;
